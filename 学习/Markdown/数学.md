...
|不等于	    |\not (斜杠)	    |$\not =$           |
|约等于     |\approx	        |$\approx$          |
|小于等于   |\leq	            |$\leq $            |less $ equal
|大于等于	|\geq	            |$\geq$             |greater & equal
|叉乘	    |\times	            |$\times$           |
|点乘	    |\cdot	            |$\cdot$            |
|加或减	    |\pm	            |$\pm$              |plus & minus
|除	        |\div	            |$\div$             |divide
|无限	    |\infty	            |$\infty$           |
|连续求和   |\sum	            |$\sum$             |
|连续求积   |\prod	            |$\prod$            |
...
详情可见：
[https://www.cnblogs.com/izcat/p/14264850.html](https://www.cnblogs.com/izcat/p/14264850.html)
